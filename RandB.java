...
/**
 * Write a description of class RandB here.
 *
 * @author Nikita Patel
 * @version 1
 */
public class RandB extends Music
{
    ...
    /**
     * Constructor for objects of class RandB
     */
    public RandB()
    {
     ...
     */
    public RandB(Fraction desireStrength, String descriptor)
    {
        //call cuper with parameter desireStrength
        super(desireStrength);
