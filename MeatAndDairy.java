...
/**
 * Write a description of class MeatAndDairy here.
 *
 * @author Nikita Patel
 * @version 1
 */
public class MeatAndDairy extends Eating 
{
    ...
    /**
     * Constructor for objects of class MeatAndDairy
     */
    public MeatAndDairy()
    {
     ...
     */
    public MeatAndDairy(Fraction desireStrength, String descriptor)
    {
         //call cuper with parameter desireStrength
        super(desireStrength);
    ...
    public double CalculateSatisfaction(Desire other)
    {
        ...
        if(this.getClass().equals(other.getClass())){
            MeatAndDairy that = (MeatAndDairy) other;
